...
Router::connect('/nha-dat', array('controller' => 'products', 'action' => 'index_product'));
Router::connect('/nha-dat/:provincelink-:provinceid',
    array('controller' => 'products', 'action' => 'index_product'),
    array(
...
Router::connect('/nha-dat/:districtlink-:districtid',
    array('controller' => 'products', 'action' => 'index_product'),
    array(
...
Router::connect('/nha-dat/:wardlink-:wardid',
    array('controller' => 'products', 'action' => 'index_product'),
    array(
...
//ban va cho thue theo group
Router::connect('/:grouplink-:groupid',
    array(
        'controller' => 'products',
        'action' => 'index_product',
    ),
...
//ban va cho thue theo group
Router::connect('/:grouplink-:groupid/:provincelink-:provinceid',
    array(
        'controller' => 'products',
        'action' => 'index_product',
    ),
...
//ban va cho thue theo group/disrtrict
Router::connect('/:grouplink-:groupid/:districtlink-:districtid',
    array(
        'controller' => 'products',
        'action' => 'index_product',
    ),
...
Router::connect('/:grouplink-:groupid/:wardlink-:wardid',
    array(
        'controller' => 'products',
        'action' => 'index_product',
    ),
...
//Category
Router::connect('/:categorylink-:categoryid',
    array(
        'controller' => 'products',
        'action' => 'index_product'
    ),
...
Router::connect('/:categorylink-:categoryid/:provincelink-:provinceid',
    array(
        'controller' => 'products',
        'action' => 'index_product',
    ),
...
Router::connect('/:categorylink-:categoryid/:districtlink-:districtid',
    array(
        'controller' => 'products',
        'action' => 'index_product',
    ),
...
Router::connect('/:categorylink-:categoryid/:wardlink-:wardid',
    array(
        'controller' => 'products',
        'action' => 'index_product',
    ),
...
/////////////////////////////////
//Can mua can thue
Router::connect('/can-mua-can-thue', array('controller' => 'products', 'action' => 'index_can_mua_can_thue'));
Router::connect('/can-mua-can-thue/:provincelink-:provinceid',
    array('controller' => 'products', 'action' => 'index_can_mua_can_thue'),
    array(
        'pass' => array('provincelink', 'provincelink'),
        'provincelink' => '[a-z0-9-]+',
        'provinceid' => '[p][0-9]+'
...
Router::connect('/can-mua-can-thue/:districtlink-:districtid',
    array('controller' => 'products', 'action' => 'index_can_mua_can_thue'),
    array(
        'pass' => array('districtlink', 'districtid'),
        'districtlink' => '[a-z0-9-]+',
...
Router::connect('/can-mua-can-thue/:wardlink-:wardid',
    array('controller' => 'products', 'action' => 'index_can_mua_can_thue'),
    array(
        'pass' => array('wardlink', 'wardid'),
        'wardlink' => '[a-z0-9-]+',
...
//Nha dat can mua
Router::connect('/can-mua-nha-dat', array('controller' => 'products', 'action' => 'index_can_mua_can_thue', 'type' => 'can-mua'));
Router::connect('/can-mua-nha-dat/:provincelink-:provinceid',
    array('controller' => 'products', 'action' => 'index_can_mua_can_thue', 'type' => 'can-mua'),
    array(
        'pass' => array('provincelink', 'provincelink'),
        'provincelink' => '[a-z0-9-]+',
        'provinceid' => '[p][0-9]+'
...
//Nha dat can thue
Router::connect('/can-thue-nha-dat', array('controller' => 'products', 'action' => 'index_can_mua_can_thue', 'type' => 'can-thue'));
Router::connect('/can-thue-nha-dat/:provincelink-:provinceid',
    array('controller' => 'products', 'action' => 'index_can_mua_can_thue', 'type' => 'can-thue'),
    array(
        'pass' => array('provincelink', 'provincelink'),
        'provincelink' => '[a-z0-9-]+',
        'provinceid' => '[p][0-9]+'
...
Router::connect('/can-mua-can-thue/can-mua-:grouplink-:groupid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-mua'
    ),
    array(
        'pass' => array('grouplink', 'groupid'),
...
Router::connect('/can-mua-can-thue/can-thue-:grouplink-:groupid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-thue'
...
//Can mua va can thue theo group
Router::connect('/can-mua-can-thue/:grouplink-:groupid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
    ),
...
///////Group/province
//Ban theo group(nha, can ho, ...)
Router::connect('/can-mua-can-thue/can-mua-:grouplink-:groupid/:provincelink-:provinceid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-mua'
...
Router::connect('/can-mua-can-thue/can-thue-:grouplink-:groupid/:provincelink-:provinceid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-thue'
...
Router::connect('/can-mua-can-thue/:grouplink-:groupid/:provincelink-:provinceid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
    ),
...
///////Group/district
//Ban theo group/ward(ban-nha/quan-1-ho-chi-minh ...)
Router::connect('/can-mua-can-thue/can-mua-:grouplink-:groupid/:districtlink-:districtid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-mua'
...
Router::connect('/can-mua-can-thue/can-thue-:grouplink-:groupid/:districtlink-:districtid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-thue'
...
Router::connect('/can-mua-can-thue/:grouplink-:groupid/:districtlink-:districtid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
    ),
...
///////Group/ward
//Ban theo group/district(ban-nha/ho-chi-minh ...)
Router::connect('/can-mua-can-thue/can-mua-:grouplink-:groupid/:wardlink-:wardid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-mua'
...
Router::connect('/can-mua-can-thue/can-thue-:grouplink-:groupid/:wardlink-:wardid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-thue'
...
Router::connect('/can-mua-can-thue/:grouplink-:groupid/:wardlink-:wardid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
    ),
...
///////////Category
//Ban theo category
Router::connect('/can-mua-can-thue/can-mua-:categorylink-:categoryid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-mua'
...
//Cho thue theo group
Router::connect('/can-mua-can-thue/can-thue-:categorylink-:categoryid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-thue'
...
//Category
Router::connect('/can-mua-can-thue/:categorylink-:categoryid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue'
    ),
...
///////Category/province
//Ban theo category/province(nha, can ho, ...)
Router::connect('/can-mua-can-thue/can-mua-:categorylink-:categoryid/:provincelink-:provinceid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-mua'
...
Router::connect('/can-mua-can-thue/can-thue-:categorylink-:categoryid/:provincelink-:provinceid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-thue'
...
Router::connect('/can-mua-can-thue/:categorylink-:categoryid/:provincelink-:provinceid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
    ),
...
/////////Category/district
Router::connect('/can-mua-can-thue/can-mua-:categorylink-:categoryid/:districtlink-:districtid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-mua'
...
Router::connect('/can-mua-can-thue/can-thue-:categorylink-:categoryid/:districtlink-:districtid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-thue'
...
Router::connect('/can-mua-can-thue/:categorylink-:categoryid/:districtlink-:districtid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
    ),
...
//
/////////category/ward
Router::connect('/can-mua-can-thue/can-mua-:categorylink-:categoryid/:wardlink-:wardid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-mua'
...
Router::connect('/can-mua-can-thue/can-thue-:categorylink-:categoryid/:wardlink-:wardid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
        'type' => 'can-thue'
...
Router::connect('/can-mua-can-thue/:categorylink-:categoryid/:wardlink-:wardid',
    array(
        'controller' => 'products',
        'action' => 'index_can_mua_can_thue',
    ),
