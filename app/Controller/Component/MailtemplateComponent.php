                                                                ...
                                                                <tr>
                                                                    <td width="100%" align="center" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background-color: #f5f5f5;" valign="top">
                                                                        <div style="color: #777777">
                                                                            <b>Công ty TNHH Tư Vấn Và Đào Tạo Hiện Thực Ước Mơ</b>
                                                                            <br>Địa chỉ VP: Số 86 Mạc Thiên Tích, Xuân Khánh, Ninh Kiều, TP Cần Thơ
                                                                            <br>SĐT: 0901 032 320
                                                                            <br>Email: cskh@dream.edu.vn
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
...
FOOTER;
    public $logo = 'http://nhadatphong.com/img/temp/logo_home1.png';
    function email_register($fullname, $email, $member_id, $code_active)
    {
                                                ...
                                                <tr>
                                                    <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                                ...
                                                                <tr>
                                                                    <td class="header-row-td" width="378" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">
                                                                        <div style="text-align: center; margin-bottom: 15px">
                                                                            <a href="$server"><img src="$this->logo" width="290px"></a>
                                                                        </div>
                                                                        Xin chào $fullname!
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                            ...
                                                            Bạn vừa đăng ký thành viên trên <a href="$server">$server</a>
                                                            </b>
                                                            <br>
                                                            Vui lòng kích hoạt tài khoản của bạn để sử dụng dịch vụ của chúng tôi
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                ...
                                                <tr>
                                                    <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                        <div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">
                                                            <a href="$server/members/active_email?code_active=$code_active&u_id=$member_id&email=$email" style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #6fb3e0; padding: 4px 9px; font-size: 15px; line-height: 21px; background-color: #6fb3e0;">&nbsp; Kích hoạt &nbsp;</a>
                                                        </div>
...
BODY;
    ...
    function email_order($fullname, $title, $packet, $expiry)
    {
        $server = 'http://' . $_SERVER['HTTP_HOST'];
        $expiry = $this->Library->convertDateTime_Mysql_to_Date($expiry);
        $html = <<<BODY
<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                        ...
                                                        <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                            <b style="color: #777777;">
                                                            Bạn vừa thanh toán xong tin bất động sản <span style="color: #478fca">$title</span>
                                                            </b>
                                                            <br>
                                                            <div style="padding-top: 20px; color: #777777;">
                                                                <b>Chi tiết gói tin</b>
                                        ...
                                        <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                            <tbody>
                                                <tr>
                                                    <td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
                                                        <div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">
                                                            <b style="color: #777777;">Cảm ơn bạn đã sử dụng dịch vụ của chúng tôi!</b>
                                                        </div>
                                                        <table class="table-space" height="16" style="height: 16px; font-size: 0px; line-height: 0; width: 378px; background-color: #ffffff;" width="378" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td class="table-space-td" valign="middle" height="16" style="height: 16px; width: 378px; background-color: #ffffff;" width="378" bgcolor="#FFFFFF" align="left">&nbsp;</td></tr></tbody></table>
                                                    </td>
                                                </tr>
