                        ...
                        <div class="row">
                            <div class="col-sm-3 text-center">
                                <label>
                                    ...
                                    <span class="lbl">
                                        <img src="/deposit/img/mobicard/viettel.png" width="150px">
                                    </span>
                                </label>
                            </div>
                            <div class="col-sm-3 text-center">
                                <label>
                                    ...
                                    <span class="lbl">
                                        <img src="/deposit/img/mobicard/mobifone.png" width="150px">
                                    </span>
                                </label>
                            </div>
                            <div class="col-sm-3 text-center">
                                <label>
                                    ...
                                    <span class="lbl">
                                        <img src="/deposit/img/mobicard/vinaphone.png" width="150px">
                                    </span>
                                </label>
                            </div>
                            <div class="col-sm-3 text-center">
                                <label>
                                    ...
                                    <span class="lbl">
                                        <img src="/deposit/img/mobicard/gate.png" width="150px">
                                    </span>
                                </label>
                            </div>
                        </div>
