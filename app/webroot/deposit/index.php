        ...
        <div class="col-sm-8 col-sm-offset-2 deposit-index">
            ...
            <div class="col-sm-4 text-center">
                <a href="/deposit/mobicard/">
                    <img src="/deposit/img/mobicard.jpg" width="100%" height="180px" style="max-width: 300px">
                    <br>
                    THẺ CÀO ĐIỆN THOẠI
                </a>
            </div>
            <div class="col-sm-4 text-center">
                <a href="/deposit/atm/">
                    <img src="/deposit/img/atm_card.png" width="100%" height="180px" style="max-width: 300px">
                    <br>
                    ATM ONLINE
                </a>
            </div>
            <div class="col-sm-4 text-center">
                <a href="/deposit/bank_account/">
                    <img src="/deposit/img/hand_money.png" width="100%" height="180px" style="max-width: 300px">
                    <br>
