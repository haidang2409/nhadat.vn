            ...
            <div id="wrapper">
                ...
                <div class="payment_list">
                    <div id="select_payment">
                        <h3 class="blue">Thông tin thanh toán - ATM</h3>
                            ...
                            <div class="row-fluid customer_info ">
                                <div class="info">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="payer_name" value="<?php echo $_SESSION['Member']['fullname'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Số điện thoại <font class="label-require">(*)</font> </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="payer_phone_no" value="<?php echo $_SESSION['Member']['phonenumber'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Địa chỉ email <font class="label-require">(*)</font> </label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="payer_email" value="<?php echo $_SESSION['Member']['email'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="total_amount" class="form-control" type="text" name="total_amount" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
