                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <?php echo $this->Form->input('groupproduct_id', array('type' => 'select', 'label' => false, 'options' => $groups, 'class' => 'form-control', 'empty' => ' -- Chọn nhóm -- ', 'default' => $categories['Category']['groupproduct_id']));?>
                        </div>
                    </div>
                    <div class="form-group">
