                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <?php echo $this->Form->input('provincetype', array('label' => false, 'class' => 'form-control', 'type' => 'select', 'options' => array('Tỉnh' => 'Tỉnh', 'Thành Phố' => 'Thành Phố')));?>
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    var uluru = {lat: 10.023, lng: 105.690};
    function initMap() {
