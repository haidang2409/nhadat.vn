                    ...
                    if(isset($provinces))
                    {
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th><?php echo $this->Paginator->sort('provincetype', 'Loại');?></th>
                                <th><?php echo $this->Paginator->sort('longitude', 'Kinh độ');?></th>
                                <th><?php echo $this->Paginator->sort('latitude', 'Vỹ độ');?></th>
                                <th>Link</th>
                                <th>
                                    Thao tác
                                </th>
                            ...
                            <?php foreach($provinces as $province): ?>
                                <tr>
                                    ...
                                    <td align="center"><?php echo $province['Province']['provincetype'];?></td>
                                    <td align="center"><?php echo $province['Province']['longitude'];?></td>
                                    <td align="center"><?php echo $province['Province']['latitude'];?></td>
