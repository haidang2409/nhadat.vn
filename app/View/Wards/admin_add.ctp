            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <?php echo $this->Form->input('wardname', array('label' => false, 'class' => 'form-control'));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="categoryname" class="col-sm-4 control-label">Loại <font class="label-require"> (*) </font> </label>
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('wardtype', array('label' => false, 'class' => 'form-control', 'type' => 'select', 'options' => array('Xã' => 'Xã', 'Phường' => 'Phường', 'Thị Trấn' => 'Thị Trấn')));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="categoryname" class="col-sm-4 control-label">Tỉnh thành <font class="label-require"> (*) </font> </label>
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('province', array('id' => 'province', 'label' => false, 'class' => 'form-control', 'type' => 'select', 'options' => $provinces, 'empty' => ' -- Chọn tỉnh thành -- '));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="username" class="col-sm-4 control-label">Quận huyện <font class="label-require"> (*) </font> </label>
                        <div class="col-sm-4 col-xs-12">
                            <?php echo $this->Form->input('district_id', array('id' => 'district', 'type' => 'select', 'label' => false, 'options' => $districts, 'class' => 'form-control', 'empty' => ' -- Chọn quận huyện -- '));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="categoryname" class="col-sm-4 control-label">Kinh độ <font class="label-require"> (*) </font> </label>
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('longitude', array('id' => 'longitude', 'label' => false, 'class' => 'form-control', 'type' => 'text'));?>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('latitude', array('id' => 'latitude', 'label' => false, 'class' => 'form-control', 'type' => 'text'));?>
                        </div>
                        <div class="col-sm-8 col-sm-offset-4 col-xs-12">
                            <div class="div-hint">
                                Hoặc kéo vị trí trên bản đồ
...
<script>
    var uluru = {lat: 10.0328, lng: 105.7793};
    function initMap() {
