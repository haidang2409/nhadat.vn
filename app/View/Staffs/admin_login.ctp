        ...
        <div class="widget-main"
            ...
            <form action='/admin/login' method="post">
                <fieldset>
                    <label class="block clearfix">
                        <span class="block input-icon input-icon-right">
                            <input id="email" name="email" class="form-control" placeholder="Email" type="text"
                                   autocomplete="off" <?php if($lock_login == true){ echo 'disabled';}?>>
                    ...
                    <div class="clearfix">
                        <button type="submit" class="width-50 pull-right btn btn-sm btn-primary" <?php if($lock_login == true){ echo 'disabled';}?>>
