                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <?php echo $this->Form->input('province', array('id' => 'province', 'type' => 'select', 'label' => false, 'options' => $provinces, 'class' => 'form-control', 'empty' => ' -- Chọn tỉnh thành -- ', 'default' => $staffs['Province']['id']));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="username" class="col-sm-4 control-label">Quận huyện</label>
                        <div class="col-sm-4 col-xs-12">
                            <?php echo $this->Form->input('district', array('id' => 'district', 'type' => 'select', 'label' => false, 'options' => $districts, 'class' => 'form-control', 'empty' => ' -- Chọn quận huyện -- ', 'value' => $staffs['District']['id']));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="username" class="col-sm-4 control-label">Phường xã</label>
                        <div class="col-sm-4 col-xs-12">
                            <?php echo $this->Form->input('ward_id', array('id' => 'ward', 'type' => 'select', 'label' => false, 'options' => $wards, 'class' => 'form-control', 'empty' => ' -- Chọn phường xã -- ', 'value' => $staffs['Ward']['id']));?>
                        </div>
                    </div>
                    <div class="form-group">
