            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="/admin/postcats/add" class="btn btn-xs btn btn-success">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php foreach($postcats as $postcat): ?>
                                <tr>
                                    ...
                                    <td><?php echo $postcat['Postcat']['name'];?></td>
                                    <td><?php echo $postcat['Postcat']['link'];?></td>
                                    <td align="center">
                                        <a class="btn btn-xs btn-warning" title="Sửa" href="/admin/postcats/edit/<?php echo $postcat['Postcat']['id'];?>"><i class="fa fa-pencil"></i> </a>
                                        <button type="button" data-postcat_id="<?php echo $postcat['Postcat']['id'];?>" data-postcatname="<?php echo $postcat['Postcat']['name'];?>" class="btn btn-xs btn-danger btn-delete-postcat" title="Xóa" href=""><i class="fa fa-trash"></i> </button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
