            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <?php echo $this->Form->input('project_category_id', array('type' => 'select', 'class' => 'form-control', 'label' => false, 'options' => $projectcats, 'empty' => ' -- Chọn nhóm dự án -- '));?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="checkbox">
                                <label>
                                    <input name="data[Project][vipproject]" class="ace ace-checkbox-2" type="checkbox" value="1" <?php if(isset($this->request->data['Project']['vipproject']) && $this->request->data['Project']['vipproject'] == 1) { echo 'checked';}?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <?php echo $this->Form->input('province', array('id' => 'province', 'type' => 'select', 'class' => 'form-control', 'label' => false, 'options' => $provinces, 'empty' => ' -- Chọn tỉnh thành -- '));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Quận huyện <font class="label-require">(*)</font> </label>
                        <div class="col-sm-6">
                            <?php echo $this->Form->input('district_id', array('id' => 'district', 'type' => 'select', 'class' => 'form-control', 'label' => false, 'options' => $districts, 'empty' => ' -- Chọn quận huyện -- '));?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea name="data[Project][description]" class="form-control">
                                <?php
                                if(isset($this->request->data['Project']['description']))
                                {
                                    echo $this->request->data['Project']['description'];
                                }
                                ?>
                            </textarea>
<!--                            --><?php //echo $this->Form->input('description', array('type' => 'textarea', 'class' => 'form-control', 'label' => false, 'rows' => 10, 'value' => html_entity_decode($menu_header)));?>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Hình ảnh đại diện <font class="label-require">(*)</font> </label>
                        <div class="col-sm-9">
