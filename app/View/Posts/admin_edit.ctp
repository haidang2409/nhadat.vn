            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('post_category_id', array('type' => 'select', 'class' => 'form-control', 'label' => false, 'options' => $postcats, 'empty' => ' -- Chọn chuyên mục -- ', 'default' => $posts['Post']['post_category_id']));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Tiêu đề bài viết <font class="label-require">(*)</font></label>
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('title', array('type' => 'text', 'class' => 'form-control', 'label' => false, 'value' => $posts['Post']['title']));?>
                            <?php echo $this->Form->input('id', array('class' => 'form-control', 'label' => false, 'value' => $posts['Post']['id']));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Tóm tắt bài viết <font class="label-require">(*)</font></label>
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('summary', array('type' => 'textarea', 'class' => 'form-control', 'label' => false, 'rows' => 2, 'value' => $posts['Post']['summary']));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Nội dung bài viết <font class="label-require">(*)</font></label>
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('description', array('type' => 'textarea', 'class' => 'form-control', 'label' => false, 'rows' => 10, 'value' => $posts['Post']['description']));?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <?php echo $this->Form->input('image_old', array('type' => 'hidden', 'class' => 'form-control', 'label' => false, 'value' => $posts['Post']['image']));?>
                        </div>
                        <div class="col-sm-9 col-sm-offset-3 col-xs-12">
                            <div class="div-hint">
                                (< 500Kb, để trống nếu không thay đổi)
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
