            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('latitude', array('id' => 'longitude', 'label' => false, 'class' => 'form-control', 'type' => 'text'));?>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('longitude', array('id' => 'latitude', 'label' => false, 'class' => 'form-control', 'type' => 'text'));?>
                        </div>
                        <div class="col-sm-8 col-sm-offset-4 col-xs-12">
                            <div class="div-hint">
                                Hoặc kéo vị trí trên bản đồ
