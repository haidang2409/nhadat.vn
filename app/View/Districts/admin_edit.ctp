            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('latitude', array('id' => 'latitude', 'label' => false, 'class' => 'form-control', 'type' => 'text', 'value' => $districts['District']['latitude']));?>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="categoryname" class="col-sm-4 control-label">Vỹ độ <font class="label-require"> (*) </font> </label>
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('longitude', array('id' => 'longitude', 'label' => false, 'class' => 'form-control', 'type' => 'text', 'value' => $districts['District']['longitude']));?>
                        </div>
                        <div class="col-sm-8 col-sm-offset-4 col-xs-12">
                            <div class="div-hint">
                                Hoặc kéo vị trí trên bản đồ
...
<script>
    var uluru = {
        lng: <?php echo ($districts['District']['latitude']) > 0? $districts['District']['latitude']: 105.7793;?>,
        lat: <?php echo ($districts['District']['longitude']) > 0? $districts['District']['longitude']: 10.0328;?>,
    };
    function initMap() {
        ...
        google.maps.event.addListener(marker, 'dragend', function(evt){
            document.getElementById('longitude').value = evt.latLng.lat().toFixed(4);
            document.getElementById('latitude').value = evt.latLng.lng().toFixed(4);
        });
