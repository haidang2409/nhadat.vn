<div class="div-social hidden-xs" style="display: none">
    ...
    <a class="btn btn-danger" title="Share Google +" href="https://plus.google.com/share?url=<?php echo $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];?>" target="_blank">
        <i class="fa fa-google-plus">

        </i>
    </a>
    <a class="btn btn-info" title="Share Twitter">
