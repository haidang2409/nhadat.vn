    ...
    <div class="row">
        ...
        <!--                                    Address-->
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <?php
                                echo $this->Form->input('address', array('id' => 'address', 'label' => false, 'class' => 'form-control', 'placeholder' => 'VD: "Số 86, đường Mạc Thiên Tích" hoặc "Đường số .. KDC 91B", .... vv'))
                                ?>
                            </div>
                                    ...
                                    <?php if(isset($this->request->data['Product']['priceminmax']) && $this->request->data['Product']['priceminmax'] == 1):?>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-xs-4">
                                                <select name="opt_price" class="opt_price">
...
<!--                            Option-->
        ...
        <!--                                    Hình ảnh-->
                        <div id="div-hinhanh">
                            <div class="form-group">
                                <label for="" class="col-sm-3 col-xs-12 control-label no-padding-right">
                                    Hình ảnh bất động sản <font class="label-require">(*)</font>
                                </label>
                                <div class="col-sm-9 col-xs-12">
