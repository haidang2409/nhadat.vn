                ...
                <div class="step-content pos-rel">
                    <div class="step-pane active" data-step="1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <?php
                                echo $this->Form->input('address', array('id' => 'address', 'label' => false, 'class' => 'form-control', 'value' => $product['Product']['address'], 'placeholder' => 'VD: "Số 86, đường Mạc Thiên Tích" hoặc "Đường số .. KDC 91B", .... '))
                                ?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3 col-xs-12">
                                <?php
                                echo $this->Form->input('email', array('id' => 'email', 'label' => false, 'class' => 'form-control', 'value' => $product['Product']['email']))
                                ?>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-3 col-xs-12">
                                    ...
                                    <?php if($product['Product']['price'] > 0 && $product['Product']['price2'] > $product['Product']['price']):?>
                                        <div class="input-group" id="price_min_max">
                                            <?php
                                            $pri_minmax = true;
                                            echo $this->Form->input('price_min', array('id' => 'price_min', 'label' => false, 'class' => 'form-control', 'type' => 'text', 'placeholder' => 'Min', 'value' => $product['Product']['price']));
                                            echo $this->Form->input('price_max', array('id' => 'price_max', 'label' => false, 'class' => 'form-control', 'type' => 'text', 'placeholder' => 'Max', 'value' => $product['Product']['price2']));
                                            ?>
                                    ...
                                    <?php else:?>
                                        <div class="input-group" id="price_dynamic">
                                            <?php
                                            echo $this->Form->input('price', array('id' => 'price', 'label' => false, 'class' => 'form-control', 'type' => 'text', 'placeholder' => 'Giá', 'autocomplete' => 'off', 'value' => $product['Product']['price']));
                                            ?>
                                            <span class="input-group-addon">
                                                Triệu
                                            </span>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            echo $this->Form->input('opt_price', array('id' => 'opt_price', 'label' => false, 'class' => 'form-control', 'type' => 'select', 'style' => 'width: 100% !important', 'empty' => ' -- Tùy chọn giá -- ', 'options' => $opt_price, 'default' => $product['Product']['opt_price']))
                                            ?>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="checkbox">
                                                <label>
                                                    <?php
                                                    echo $this->Form->input('Product.pricedeal', array('id' => 'chk_deal', 'type' => 'checkbox', 'div' => false, 'class' => 'ace', 'label' => false, 'value' => 1, 'disabled' => $pri_minmax, 'checked' => $price_deal))
                                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 col-xs-12">
                                    <div class="input-group" id="div-acreage">
                                        <?php
                                        $acreage_minmax = false;
                                        ?>
                                        <?php if($product['Product']['acreage2'] == 0 && $product['Product']['acreage'] > 0):?>
                                            <?php
                                ...
                                <div class="col-sm-3 col-xs-12">
                                    <div class="checkbox">
                                        <label>
                                            <?php
                                            echo $this->Form->input('Product.acreage_minmax', array('id' => 'chk_acreage_min_max', 'type' => 'checkbox', 'div' => false, 'class' => 'ace', 'label' => false, 'value' => 1, 'checked' => $acreage_minmax))
                                            ?>
