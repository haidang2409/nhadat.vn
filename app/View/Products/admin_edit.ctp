                    ...
                    <div class="step-pane active" data-step="1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <div class="radio">
                                    <?php
                                    $type = $product['Product']['transactiontype_id'];
                                    if($type == 1 || $type == 2)
                                    {
                                        ?>
                                        <label>
                                            <input name="data[Product][transactiontype_id]" class="ace" type="radio" value="1" <?php if($type == 1){ echo 'checked';}?>>
                                    ...
                                    else
                                    {
                                        ?>
                                        <label>
                                            <input name="data[Product][transactiontype_id]" class="ace" type="radio" value="3" <?php if($type == 3){ echo 'checked';}?>>
                        ...
                        <script>
                            $(function () {
                                $('#id-input-file-3').ace_file_input({
                                    style: 'well',
                                    btn_choose: 'Click để chọn hình ảnh hoặc kéo hình ảnh vào đây .Mỗi hình ảnh dung lượng không quá 2Mb',
                                    btn_change: null,
                        ...
                        <div class="text-right">
                            <hr>
                            <button class="btn btn-white btn-xs" type="reset"> <i class="fa fa-refresh"></i> Nhập lại</button>
                            <button class="btn btn-primary btn-xs" type="submit">Tiếp tục <i class="fa fa-arrow-right"></i> </button>
                        </div>
                        <!--                                    End div houseorland-->
                        <?php
                        echo $this->Form->end();
