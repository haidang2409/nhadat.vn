            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('title', array('type' => 'text', 'class' => 'form-control', 'label' => false, 'value' => $recruitments['Recruitment']['title']));?>
                            <?php echo $this->Form->input('id', array('type' => 'hidden', 'class' => 'form-control', 'label' => false, 'value' => $recruitments['Recruitment']['id']));?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Mô tả tin tuyển dụng <font class="label-require">(*)</font></label>
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('content', array('type' => 'textarea', 'class' => 'form-control', 'label' => false, 'rows' => 10, 'value' => $recruitments['Recruitment']['content']));?>
                        </div>
                    </div>
                    <div class="form-group">
